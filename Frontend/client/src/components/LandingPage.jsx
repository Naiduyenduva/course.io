    ...
    <>
      <div className='bg-black h-screen pt-24'>
        <div className='grid justify-center text-white'>
          <div>
              <h1 className='text-blue-600 text-5xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none text-center mt-0'>Course.io</h1>
              ...
              <button className='bg-gray-100 text-black lg:w-60 w-32 h-12 rounded-lg'>Get Started</button>
          </div>
        </div>
        <MovingCard />
    </div>
